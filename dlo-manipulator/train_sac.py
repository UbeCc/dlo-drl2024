...
if __name__ == "__main__":
    ...
    parser.add_argument("--exp_n", type=str, required=True, help="Name of the experiment")
    ...
    parser.add_argument("--log_dir", type=str, default='./logs_sac/', help="Directory for logging")
    ...
    log_dir = os.path.join(args.log_dir, f"{args.exp_n}_{time_stamp}")
    ...
    # Create a SAC model with the learning rate schedule
    ...
    # Train the agent
    model.learn(total_timesteps=int(timesteps), callback=callback, tb_log_name=f"{args.exp_n}_{time_stamp}", log_interval=1)
